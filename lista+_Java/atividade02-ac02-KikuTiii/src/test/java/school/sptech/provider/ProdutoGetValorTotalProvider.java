...
public class ProdutoGetValorTotalProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(List.of(p7, p2, p4), 210.0 + 299.99 + 259.90),
        Arguments.of(List.of(p3, p8, p1, p10), 489.90 + 1200.00 + 1500.00 + 59.90),
        Arguments.of(List.of(p9, p5), 899.99 + 5800.00),
        Arguments.of(List.of(p2, p7, p3, p1, p4, p6), 299.99 + 210.00 + 489.90 + 1500.00 + 259.90 + 350.00),
        Arguments.of(List.of(p8), 1200.0),
