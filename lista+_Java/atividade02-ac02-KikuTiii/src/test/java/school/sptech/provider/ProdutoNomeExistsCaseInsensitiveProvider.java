...
public class ProdutoNomeExistsCaseInsensitiveProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(List.of(p7, p2, p4), "fone de ouvido bluetooth", true),
        Arguments.of(List.of(p3, p8, p1, p10), "SMARTPHONE XYZ", true),
        Arguments.of(List.of(p9, p5), "Smartphone XYZ", false),
        Arguments.of(List.of(p2, p7, p3, p1, p4, p6), "Livro - O Mundo de Sofia", false),
        Arguments.of(List.of(p8), "Relógio SMARTtech", true)
    );
  }
}
