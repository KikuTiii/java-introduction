...
public class ProdutoProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(List.of(p7, p2, p4)),
        Arguments.of(List.of(p3, p8, p1, p10)),
        Arguments.of(List.of(p9, p5)),
        Arguments.of(List.of(p2, p7, p3, p1, p4, p6)),
        Arguments.of(List.of(p8))
    );
  }
}
