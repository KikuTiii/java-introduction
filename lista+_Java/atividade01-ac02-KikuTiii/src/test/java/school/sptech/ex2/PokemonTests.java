...
@DisplayName("Atividade 2 - Pokémon (Pokemon)")
  ...
  class AtributosTests {
    ...
    void cenario1() {
      ...
      Assertions.assertAll(
          ...
          () -> Assertions.assertDoesNotThrow(() -> clazz.getDeclaredField("tipo")),
          () -> Assertions.assertDoesNotThrow(() -> clazz.getDeclaredField("forca")),
          () -> Assertions.assertDoesNotThrow(() -> clazz.getDeclaredField("doces"))
      );
    }
  }
